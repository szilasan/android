...
function apply_language() {
	$("#lang-form > #title").html( t('language_title') );
...
//	$(".page-ship-det legend").html(t('shipment_info'));
	...
	$(".page-album #header #title").html( t('album_title') );
	$(".page-album #header .action_save").html( t('action_submit') );
	
	$('.page-photo-preview #header #title').html( t('photo_preview_title') );
	...
	$(".page-details #header #title").html( t('shipment_title') );
	$(".page-details #header .arrow-left").html( t('back') );
}